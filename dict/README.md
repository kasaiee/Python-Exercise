...
10.در تلفن های همراه ساده برای ارسال پیامک لزم است از دکمه های ۰ تا ۹ استفاده کنید به
طوری که مث ۱ ،حرف A و با فشردن دوبار دکمه ۱ ،حرف B درج لل با فشردن یک بار دکمه
می شود. اکنون میخواهیم این ساختار را شبیه سازی کنیم. به جدول زیر توجه کنید:
